...
switch lower(objType)
    ...
    case 'rosen'
        ...
        if nVars <= 100
        methods = {'sd','csd','cg','scg','bb','newton0','pnewton0','lbfgs','qnewton','mnewton','newton','tensor'};
        else
            methods = {'sd','csd','cg','scg','bb','newton0','pnewton0','lbfgs','qnewton','mnewton','newton'};
        end
        w_init = zeros(nVars,1);
    case 'logistic'
    ...
    case 'neural'
        ...
        minObj = funObj(w);
        methods = {'sd','csd','cg','scg','bb','newton0','pnewton0','lbfgs','qnewton'};
    case 'kernel'
        nInstances = 250;
        nFeatures = 3;

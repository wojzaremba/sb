...
if edgeStruct.useMex
   % Mex Code
   edgePot = UGM_makeEdgePotentialsC(ones(1,1,edgeStruct.nEdges),v,int32(edgeStruct.edgeEnds),int32(edgeStruct.nStates),int32(infoStruct.tieEdges),int32(infoStruct.ising));
else
   % Matlab Code
   edgePot = makeEdgePotentials(ones(1,1,edgeStruct.nEdges),v,edgeStruct,infoStruct);
end
end

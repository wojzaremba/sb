...
[verbose,numDiff,optTol,maxIter,maxProject,suffDec,corrections,adjustStep,bbInit,SPGoptTol,SPGiters] = ...
    myProcessOptions(...
    options,'verbose',2,'numDiff',0,'optTol',1e-6,'maxIter',500,'maxProject',inf,'suffDec',1e-4,...
    'corrections',100,'adjustStep',0,'bbInit',1,'SPGoptTol',1e-6,'SPGiters',inf);
...
while funEvals <= maxIter
    ...
    if i == 1
        ...
        if bbInit
            ...
            % Solve Sub-problem
            [p,subProjects] = solveSubProblem(x,g,HvFunc,funProj,SPGoptTol,SPGiters,x-alpha*g);
        else
            % Solve Sub-problem
            [p,subProjects] = solveSubProblem(x,g,HvFunc,funProj,SPGoptTol,SPGiters,x);
        end
...
function [p,subProjects] = solveSubProblem(x,g,H,funProj,optTol,maxIter,x_init)

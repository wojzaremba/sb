classdef(Sealed) hillclimber < org.mensxmachina.pgm.bn.learning.structure.structurelearner
...
%   ORG.MENSXMACHINA.PGM.BN.LEARNING.STRUCTURE.SNS.LOCAL.LOCALSCORER.
    ...
    ip.addRequired('LocalScorer', @(a) isa(a, 'org.mensxmachina.pgm.bn.learning.structure.sns.local.localscorer'));
...
%   LOCALLOGSCORES sum to LOGSCORE.
    ...
    ancestors = org.mensxmachina.graph.ancestormatrix(structure);

...
% 3. Consider conditioning on all parents since we now don't lose power.
...
bnet = mk_asia_linear(5); %mk_bnet4();
K = length(bnet.dag);
...
mat_file_command = sprintf('save asia_linear_arity_%d.mat',arity);

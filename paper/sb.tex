...
\begin{figure}[h]
\centering
\includegraphics[width=0.35\linewidth]{img/independence_surface.eps}
...
We have first performed extensive experiments on ``asia'' network. We aimed to compare power of 
independence tests.

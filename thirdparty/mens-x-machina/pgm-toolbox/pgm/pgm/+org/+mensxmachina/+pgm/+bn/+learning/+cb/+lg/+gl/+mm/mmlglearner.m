classdef(Sealed) mmlglearner < org.mensxmachina.pgm.bn.learning.cb.lg.gl.glglearner
...
%   ORG.MENSXMACHINA.PGM.BN.LEARNING.CB.LG.GL.GLGLEARNER/GLGLEARNER.
    ...
    Obj = Obj@org.mensxmachina.pgm.bn.learning.cb.lg.gl.glglearner(DSepDeterminer, varargin{:});
    
    % parse specific input
    assert(isa(CACalculator, 'org.mensxmachina.pgm.bn.learning.cb.lg.gl.mm.cacalculator') && isscalar(CACalculator) && CACalculator.nVars == DSepDeterminer.nVars);
...
function [xOpenInd xOpenPriorityQueue] = ...
    ...
    import org.mensxmachina.pgm.bn.learning.cb.sepsetidentifieddata;

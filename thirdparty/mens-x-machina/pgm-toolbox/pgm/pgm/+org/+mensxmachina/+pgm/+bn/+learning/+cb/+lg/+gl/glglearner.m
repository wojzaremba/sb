classdef glglearner < org.mensxmachina.pgm.bn.learning.cb.lg.lglearner
...
%   See also ORG.MENSXMACHINA.PGM.BN.LEARNING.CB.DSEPDETERMINER.
    ...
    ip.addRequired('DSepDeterminer', @(a) isa(a, 'org.mensxmachina.pgm.bn.learning.cb.dsepdeterminer') && isscalar(a));
    ...
    % constructor
    Obj = Obj@org.mensxmachina.pgm.bn.learning.cb.lg.lglearner(DSepDeterminer.nVars, ip.Results.symCorrEnabled);
